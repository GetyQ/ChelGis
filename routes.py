    ...
    if Attraction.query.count() == 0:
        ...
        attractions = [
            ...
            Attraction(
                ...
                description="Один из крупнейших музеев Урала с богатой коллекцией исторических артефактов. Здесь представлены уникальные экспонаты, рассказывающие об истории Южного Урала и Челябинска.",
                lat=55.159388,
                lng=61.402429,
